...
//   return (
//     <div className="flex justify-center sm:mt-4 pb-24">
//       {savedMessage && (
...
//         {/* <CHANGE> Updated header styling with cleaner design and better spacing */}
//         <div className="sm:rounded-xl overflow-hidden shadow-lg bg-white sm:border border-gray-100">
//           <div className="bg-linear-to-r from-blue-600 to-blue-700 text-white px-4 py-6 sm:px-6">
//             <div className="flex items-center justify-between mb-6">
//               <div className="flex items-center gap-3">
//                 <button
//                   onClick={() => navigate(-1)}
//                   className="p-2 rounded-lg hover:bg-white/20 transition-colors hover:cursor-pointer"
//                 >
//                   <LeftArrowIcon />
//                 </button>
//                 <div>
//                   <div className="font-semibold text-lg">Select Players</div>
//                 </div>
//               </div>
//               <div className="text-sm text-blue-100">Pick Captain later</div>
//             </div>
...
//                     <div className="w-14 h-14 bg-white rounded-full flex items-center justify-center border-2 border-blue-100 relative shadow-sm">
//                       {t?.logo ? (
//                         <img
...
//                       </div>
//                     </div>
//                     <div className="text-xs text-blue-50 font-medium">
//                       {t.short || t.name}
//                     </div>
//                   </div>
//                 );
...
//                 <div className="text-xs text-blue-100 mb-3 font-medium">
//                   Max {MAX_FROM_ONE_TEAM ?? 7} per team
//                 </div>
...
//                   </div>
//                   <div className="flex flex-col items-center">
//                     <div className="text-3xl font-bold">{creditsLeft}</div>
//                     <span className="text-xs text-blue-100 font-medium mt-1">
//                       Credits
//                     </span>
//                   </div>
...
//               {ROLE_ORDER.map((r) => {
//                 const cnt = (playersByRole[r] || []).length;
//                 const selCnt = selected.filter((s) => s.role === r).length;
//                 return (
//                   <button
//                     key={r}
//                     onClick={() => setActiveRole(r)}
//                     className={`flex items-center justify-center gap-2 px-4 py-2 rounded-lg font-medium transition-all whitespace-nowrap hover:cursor-pointer ${
//                       activeRole === r
...
//                   >
//                     <div>{r}</div>
//                     <div className="text-sm opacity-75">({selCnt})</div>
//                   </button>
//                 );
//               })}
//             </div>
...
//             <div className="px-6 pr-16 py-3 bg-gray-50 flex justify-between text-xs font-semibold text-gray-600 border-b border-gray-100">
//               <div>
//                 {activeRole === "BAT"
//                   ? "Batsmen"
//                   : activeRole === "BOWL"
